...
### 3.4.1 Digression: Difference between Unique vs. Distinct 
...
![](/post/2021-03-26-data-aggregation_files/p10p13.png)
...
### 3.5.1 Simple Group By with AVG
...
### 3.5.2 Group and Order By with AVG
...
### 3.5.3 Group and Order By with ABS & STDEV
...
### 3.5.4 Group and Order By with MAX
...
### 3.5.5 Multiple Group and Order By
