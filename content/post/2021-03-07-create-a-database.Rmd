...
## 3.2 Create a Database for Deletion
...
### 3.2.4 Delete the whole Database

Like tables, entire databases can be deleted.

Since I would like to have the output of [SSMS](https://docs.microsoft.com/en-us/sql/ssms/sql-server-management-studio-ssms?view=sql-server-ver15) always in English I use the following syntax and try to delete the database. 
