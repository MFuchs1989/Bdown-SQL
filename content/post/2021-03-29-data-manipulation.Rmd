...
### 3.1.1 Creat an Index via Primary Key
...
### 3.1.2 Creat an Index via a new Column (recommended)
...
### 3.2.1 Replace NULL Values (ISNULL)
...
### 3.2.2 Replace Values with NULL (NULLIF)
...
### 3.2.3 IF Else Statemtents in SQL (CASE)
...
### 3.2.4 IF Statemtents in SQL (IIF)
...
#### 3.2.5.1 Replace NULL Values with the columns'average
...
#### 3.2.5.2 Coalesce for String Concatenation
...
#### 3.2.5.3 Compare SQL Server COALESCE to CASE
...
#### 3.2.5.4 Compare SQL Server COALESCE to ISNULL
...
![](/post/2021-03-29-data-manipulation_files/p11p.png)
