---
title: Create a m:m Relationship
...
As already announced in my post [Create a 1:m Relationship](https://michael-fuchs-sql.netlify.app/2021/03/13/create-a-1-m-relationship/), we now come to the last general type of relationship between two tables that I would like to deal with here: a **m:m relationship**
...
In this post I have shown how to set up an m:m relationship between two tables using an Associative Table and how to query on it.
