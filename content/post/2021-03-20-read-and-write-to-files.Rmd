...
Before we get into the interesting things like data wrangling, aggregation and manipulation, I would like to briefly explain the import and export of files in [SSMS](https://docs.microsoft.com/en-us/sql/ssms/sql-server-management-studio-ssms?view=sql-server-ver15). 


For this post I created a TestCSV.csv and used the dataset *flight* from the statistics platform ["Kaggle"](https://www.kaggle.com). You can download it from my [GitHub Repository](https://github.com/MFuchs1989/Datasets-and-Miscellaneous/tree/main/datasets).
...
![](/post/2021-03-20-read-and-write-to-files_files/p8p.png)
